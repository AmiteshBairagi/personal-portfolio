  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="relative group">
        ...
        <div className="relative bg-slate-900/50 backdrop-blur-xl border border-slate-800 p-8 md:p-12 rounded-3xl">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {coreValues.map((value, i) => (
          <motion.div
            ...
            whileHover={{ y: -5 }}
            className={`p-8 rounded-2xl border border-slate-800 bg-gradient-to-br ${value.color} backdrop-blur-sm group transition-all duration-300`}
          >
            <div className="w-12 h-12 rounded-xl bg-slate-900 flex items-center justify-center text-cyan-400 mb-6 group-hover:scale-110 transition-transform">
              {value.icon}
            </div>
      ...
      <motion.div variants={itemVariants} className="space-y-10">
        <div className="flex items-center gap-4">
          ...
          <h3 className="text-2xl font-bold text-white">Tech Philosophy</h3>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {philosophy.map((item, i) => (
            <div key={i} className="space-y-4">
              <span className="text-5xl font-black text-slate-800/50 block mb-2">{item.label}</span>
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-900/40 border border-slate-800 p-8 rounded-3xl flex items-start gap-6">
          <div className="p-3 bg-pink-500/10 rounded-lg text-pink-500">
            <Coffee size={24} />
          </div>
          <div>
            <h4 className="text-white font-bold mb-2 text-lg">Current Status</h4>
        ...
        <div className="bg-slate-900/40 border border-slate-800 p-8 rounded-3xl flex items-start gap-6">
          ...
          <div>
            <h4 className="text-white font-bold mb-2 text-lg">Next Goal</h4>
            <p className="text-slate-400 text-sm">
