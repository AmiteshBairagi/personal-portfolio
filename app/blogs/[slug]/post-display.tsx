    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 pt-6 pb-8">
        ...
        <motion.div
          ...
          className="max-w-4xl mx-auto mb-8 bg-gradient-to-r from-slate-800/30 to-slate-800/10 p-6 md:p-7 rounded-xl border border-slate-700/50 backdrop-blur-sm"
        >
          ...
          {/* Title */}
          <h1 className="max-w-3xl text-3xl md:text-4xl font-bold bg-gradient-to-r from-white to-slate-200 bg-clip-text text-transparent mb-4 leading-snug">
            {post.title}
          </h1>

          {/* Meta Information */}
          <div className="flex flex-wrap items-center gap-4 text-slate-400 mb-6 pb-6 border-b border-slate-700/30">
              ...
              <div className="prose prose-invert prose-cyan max-w-none prose-lg">
                {hasMarkdown ? (
                  ...
                  paragraphs.map((paragraph, index) => (
                    <p key={`${post.id}-paragraph-${index}`} className="text-slate-300 mb-4 leading-relaxed">
                      {paragraph}
                    </p>
                  ))
                )}
