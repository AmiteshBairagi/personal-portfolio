              ...
              >
                ...
                <Link href="#projects" className="w-full sm:w-auto block">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full sm:w-auto px-6 py-3 bg-slate-900/50 hover:bg-slate-800 text-slate-200 border border-slate-700 hover:border-slate-500 rounded-xl font-medium transition-all text-sm sm:text-base backdrop-blur-sm flex items-center justify-center gap-2"
                  >
                    View My Work
                  </motion.button>
                </Link>
                ...
                <Link href="/interview-experience" className="w-full sm:w-auto block">
                  <motion.button
                    whileHover={{ scale: 1.02, backgroundColor: "rgba(30,30,30,0.8)", borderColor: "rgba(168,85,247,0.5)" }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full sm:w-auto px-6 py-3 bg-slate-900/50 hover:bg-slate-800 text-slate-200 border border-slate-700 hover:text-purple-400 rounded-xl font-medium transition-all text-sm sm:text-base backdrop-blur-sm flex items-center justify-center gap-2"
                  >
